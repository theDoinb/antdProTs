    ...
    return (
      <Card>
        <ReactGridLayout onResizeStop={this.handleResize} className="layout" cols={12} rowHeight={30} width={1200} {...this.props}>
          ...
          <div key="b" data-grid={{x: 0, y: 0, w: 6, h: 10}} style={{border:'1px solid #e8e8e8'}}>
            <ReactEcharts option={data2} style={{height:'100%',width:'100%'}} />
          </div>
          <div key="c" data-grid={{x: 6, y: 0, w: 6, h: 10}} style={{border:'1px solid #e8e8e8'}}>
            <ReactEcharts option={data1} style={{height:'100%',width:'100%'}} />
          </div>
        </ReactGridLayout>
      </Card>
    )
